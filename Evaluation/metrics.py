...
def analyze_reasoning_content(
    ...
    # Calculate means
    avg_male_terms = np.mean(male_term_counts)
    avg_female_terms = np.mean(female_term_counts)
    avg_male_traits = np.mean(male_trait_counts)
    avg_female_traits = np.mean(female_trait_counts)
